...
# Async function to send a message daily at config time
async def daily_message():
    ...
    while not client.is_closed():
        wait_seconds = seconds_until_hour_of_day(DAILY_MESSAGE_HOUR)
        await asyncio.sleep(wait_seconds) # Wait until the specified time
        await channel.send("Good morning! Here's your daily message.")  # Your message
        # Wait a day before sending the next message
        await asyncio.sleep(24*60*60 - wait_seconds)
